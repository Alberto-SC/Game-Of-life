function realTimeLineChart() {
    ...
    function chart(selection) {
      array = {"x":"Población","y":"Densidad","z":"Entropía"}  
        ...
        var yMin = d3.min(data, function(c) { return d3.min(c.values, function(d) { return d.value; })});
        var yMax = d3.max(data, function(c) { return d3.max(c.values, function(d) { return d.value; })});
        ...
        var legendEnter = gEnter.append("g")
          .attr("class", "legend")
          .attr("transform", "translate(" + (width-margin.right-margin.left-150) + ",25)");
        ...
        g.select("g.axis.x")
          .attr("transform", "translate(20," + (height-margin.bottom-margin.top) + ")")
          .transition(t)
