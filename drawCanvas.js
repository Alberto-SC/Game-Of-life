...
function CanvasDrawer() {
    ...
    this.draw_node = function(node,size,left,top){
        ...
        if(size<=1){
            if(node.poblacion)
                this.square(left + Ofset_x | 0 ,top + Ofset_y | 0 ,1);
        }
            ...
            if(node.poblacion){
                ...
                // context.fill();
                this.square(left + Ofset_x, top+ Ofset_y,drawer.cell_width);
            }
        }
